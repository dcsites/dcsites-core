...
class Dashboard extends Core {
	 ...
	 *
	 * @return class Singleton of this class
	 */
	...
	/**
	 * Run our "activation" function on plugin update
	 */
	...
	public function dashboard_widget_help() {
		...
		$copy = sprintf( $copy, admin_url( 'admin.php?page=wp101' ) );
